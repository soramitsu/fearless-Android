...
@AndroidEntryPoint
class TonConnectionsFragment : BaseComposeBottomSheetDialogFragment<TonConnectionsViewModel>() {

    override val viewModel: TonConnectionsViewModel by viewModels()
    ...
    override fun Content(padding: PaddingValues) {
        ...
        TonConnectionsContent(
            state = state,
            onDappClick = viewModel::onDappClicked,
