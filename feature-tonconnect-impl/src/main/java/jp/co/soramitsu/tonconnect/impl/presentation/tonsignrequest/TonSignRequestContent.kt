...
@Composable
fun TonSignRequestContent(state: TonSignRequestViewState, callback: TonSignRequestScreenInterface) {
    BottomSheetScreen {
        Column(
            modifier = Modifier
...
@Preview
@Composable
private fun TonSignRequestPreview() {
    val state = TonSignRequestViewState(
    ...
    val emptyCallback = object : TonSignRequestScreenInterface {
