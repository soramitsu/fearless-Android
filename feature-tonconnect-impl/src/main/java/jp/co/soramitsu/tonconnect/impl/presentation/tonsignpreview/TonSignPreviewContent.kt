...
data class TonSignPreviewViewState(
...
interface TonSignPreviewScreenInterface {
    fun onClose()
    fun onSignClick()
...
@Composable
fun TonSignPreviewContent(state: TonSignPreviewViewState, callback: TonSignPreviewScreenInterface) {
    BottomSheetScreen {
        Column(
            modifier = Modifier
...
@Preview
@Composable
private fun TonSignPreviewPreview() {
    ...
    val state = TonSignPreviewViewState(
        chainIcon = GradientIconState.Local(R.drawable.ic_fearless_logo),
    ...
    val emptyCallback = object : TonSignPreviewScreenInterface {
