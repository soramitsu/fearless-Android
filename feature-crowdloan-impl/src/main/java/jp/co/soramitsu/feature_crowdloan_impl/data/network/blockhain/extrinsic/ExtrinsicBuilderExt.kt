...
fun ExtrinsicBuilder.contribute(parachainId: ParaId, contribution: BigInteger, signature: String? = null, encryptionType: EncryptionType? = null): ExtrinsicBuilder {
    return call(
        ...
        arguments = mapOf(
            ...
            "signature" to DictEnum.Entry(
                name = encryptionType?.rawName?.capitalize().orEmpty(),
                value = signature?.fromHex()
            )
        )
    )
}
