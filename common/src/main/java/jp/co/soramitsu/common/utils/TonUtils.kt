...
/**
 * Initializes the fixed wallet code before concurrent wallet scans begin.
 * TON 0.3.1's BOC parser waits for Default-dispatcher work; first touching this
 * class from a saturated Default pool can deadlock its class initializer.
 */
fun initializeTonAddressCode() {
    // Calling this method initializes v4r2Code on the startup thread.
    v4r2Code
}
