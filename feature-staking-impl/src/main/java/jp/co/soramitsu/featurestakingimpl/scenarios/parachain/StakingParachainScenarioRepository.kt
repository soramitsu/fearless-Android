...
import jp.co.soramitsu.featurestakingapi.domain.model.toDelegations
import jp.co.soramitsu.featurestakingimpl.data.network.blockhain.bindings.bindAtStakeOfCollator
import jp.co.soramitsu.featurestakingimpl.data.network.blockhain.bindings.bindCandidateInfo
import jp.co.soramitsu.featurestakingimpl.data.network.blockhain.bindings.bindDelegationScheduledRequests
import jp.co.soramitsu.featurestakingimpl.data.network.blockhain.bindings.bindDelegatorState
import jp.co.soramitsu.featurestakingimpl.data.network.blockhain.bindings.bindRound
import jp.co.soramitsu.featurestakingimpl.data.network.blockhain.bindings.bindSelectedCandidates
import jp.co.soramitsu.featurestakingimpl.data.network.blockhain.bindings.bindStaked
