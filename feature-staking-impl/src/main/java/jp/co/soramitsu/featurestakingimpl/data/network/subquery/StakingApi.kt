package jp.co.soramitsu.featurestakingimpl.data.network.subquery
...
import jp.co.soramitsu.featurestakingimpl.data.network.subquery.request.StakingAllCollatorsApyRequest
import jp.co.soramitsu.featurestakingimpl.data.network.subquery.request.StakingCollatorsApyRequest
import jp.co.soramitsu.featurestakingimpl.data.network.subquery.request.StakingDelegatorHistoryRequest
import jp.co.soramitsu.featurestakingimpl.data.network.subquery.request.StakingEraValidatorInfosRequest
import jp.co.soramitsu.featurestakingimpl.data.network.subquery.request.StakingLastRoundIdRequest
