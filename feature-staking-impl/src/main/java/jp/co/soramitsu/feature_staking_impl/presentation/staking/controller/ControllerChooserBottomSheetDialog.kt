...
class ControllerChooserBottomSheetDialog(
    context: Context,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTitle(R.string.staking_controller_account)
    }
...
private class AddressModelHolder(parent: View) : DynamicListSheetAdapter.Holder<AddressModel>(parent) {
    override fun bind(item: AddressModel, isSelected: Boolean, handler: DynamicListSheetAdapter.Handler<AddressModel>) {
