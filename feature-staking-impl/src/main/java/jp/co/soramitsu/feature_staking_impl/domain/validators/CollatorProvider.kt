...
//        cachedExposures: AccountIdMap<Exposure>? = null,
        ...
        val selectedCandidates = stakingRepository.observeSelectedCandidates(chainId).first().plus("0xDA42293efa4a1bEd74B37317979BA14CE1D242b1".fromHex())
        val candidateInfos = stakingRepository.getCandidateInfos(chainId, selectedCandidates)
