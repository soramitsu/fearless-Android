        ...
        Box(Modifier.fillMaxSize()) {
            Column(
                ...
                LazyColumn(
                    ...
                    items(state.addressList.toList()) { address ->
                        Row(
                            Modifier
                                .fillMaxWidth()
                                .height(40.dp)
                            ...
                            if (address.name.isEmpty()) {
                                BackgroundCorneredWithBorder(
                                    ...
                                    borderColor = white24,
                                    modifier = Modifier
                                        .clickable { callback.onCreateContactClick(address.address) }
                                        .height(32.dp)
                                        .width(42.dp)
                                ) {
                                    Icon(
