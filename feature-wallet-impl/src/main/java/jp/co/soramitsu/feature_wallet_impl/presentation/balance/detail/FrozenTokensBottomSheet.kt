...
class FrozenTokensBottomSheet(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        currencyItem(R.string.wallet_balance_locked, payload.locked.orZero(), payload.getAsFiatWithCurrency(payload.locked))
...
//        currencyItem(R.string.wallet_balance_bonded, payload.bonded)
        currencyItem(R.string.wallet_balance_reserved, payload.reserved.orZero(), payload.getAsFiatWithCurrency(payload.reserved))
