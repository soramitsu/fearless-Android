...
class BalanceDetailsBottomSheet(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        currencyItem(
            ...
            transferDraft.totalAfterTransfer(assetModel.total)
        )
        currencyItem(
            R.string.wallet_balance_details_existential_deposit,
            assetModel.token.type.networkType.runtimeConfiguration.existentialDeposit
        )
    }
}
