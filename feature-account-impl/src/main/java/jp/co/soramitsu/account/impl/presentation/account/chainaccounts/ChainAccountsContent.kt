...
interface ChainAccountsCallback {
...
@Composable
internal fun ChainAccountsContent(
    state: ChainAccountsState,
    callback: ChainAccountsCallback
) {
    Column(
...
private fun PreviewChainAccountsContent() {
    ...
    FearlessAppTheme {
        ChainAccountsContent(
            state = state,
            callback = object : ChainAccountsCallback {
