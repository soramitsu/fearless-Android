...
import jp.co.soramitsu.domain.model.Node.NetworkType.KUSAMA
import jp.co.soramitsu.domain.model.Node.NetworkType.POLKADOT
import jp.co.soramitsu.domain.model.Node.NetworkType.WESTEND
...
data class NetworkModel(
    ...
    sealed class NetworkTypeUI(val icon: Int, val networkType: jp.co.soramitsu.domain.model.Node.NetworkType) {
