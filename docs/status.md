...
- Focused after-image/projection JVM cases pass 11/11 and the full account module passes 277/277 with no failures or skips against pinned Utils `1c80a2bf3fa1f996cf1328873e09f282ee29b69e`. Forced scoped Detekt covers both changed Kotlin files; these local checks are component evidence only.
