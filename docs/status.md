...
- This does not establish an app-owned first-generation exporter, a public-identity digest, installed-key signing/export, complete metadata preservation, transactional installation, or actual replacement-device recovery. The verifier is not a backup-complete authority; the compiled recovery gate remains false.
