...
interface DemeterFarmingRepository {
    ...
    suspend fun deposit(chainId: String, pool: DemeterFarmingBasicPool, amount: BigDecimal): Result<String>
    suspend fun withdraw(chainId: String, pool: DemeterFarmingPool, amount: BigDecimal): Result<String>
