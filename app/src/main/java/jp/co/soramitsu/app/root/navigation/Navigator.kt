...
import jp.co.soramitsu.featureonboardingimpl.presentation.welcome.WelcomeFragment
import jp.co.soramitsu.featurestakingimpl.presentation.StakingRouter
import jp.co.soramitsu.featurestakingimpl.presentation.payouts.confirm.ConfirmPayoutFragment
import jp.co.soramitsu.featurestakingimpl.presentation.payouts.confirm.model.ConfirmPayoutPayload
import jp.co.soramitsu.featurestakingimpl.presentation.payouts.detail.PayoutDetailsFragment
import jp.co.soramitsu.featurestakingimpl.presentation.payouts.model.PendingPayoutParcelable
import jp.co.soramitsu.featurestakingimpl.presentation.staking.balance.StakingBalanceFragment
import jp.co.soramitsu.featurestakingimpl.presentation.staking.bond.confirm.ConfirmBondMoreFragment
import jp.co.soramitsu.featurestakingimpl.presentation.staking.bond.confirm.ConfirmBondMorePayload
import jp.co.soramitsu.featurestakingimpl.presentation.staking.bond.select.SelectBondMoreFragment
import jp.co.soramitsu.featurestakingimpl.presentation.staking.bond.select.SelectBondMorePayload
import jp.co.soramitsu.featurestakingimpl.presentation.staking.controller.confirm.ConfirmSetControllerFragment
import jp.co.soramitsu.featurestakingimpl.presentation.staking.controller.confirm.ConfirmSetControllerPayload
import jp.co.soramitsu.featurestakingimpl.presentation.staking.rebond.confirm.ConfirmRebondFragment
import jp.co.soramitsu.featurestakingimpl.presentation.staking.rebond.confirm.ConfirmRebondPayload
import jp.co.soramitsu.featurestakingimpl.presentation.staking.redeem.RedeemFragment
import jp.co.soramitsu.featurestakingimpl.presentation.staking.redeem.RedeemPayload
import jp.co.soramitsu.featurestakingimpl.presentation.staking.rewardDestination.confirm.ConfirmRewardDestinationFragment
...
import jp.co.soramitsu.featurestakingimpl.presentation.staking.unbond.confirm.ConfirmUnbondFragment
import jp.co.soramitsu.featurestakingimpl.presentation.staking.unbond.confirm.ConfirmUnbondPayload
import jp.co.soramitsu.featurestakingimpl.presentation.staking.unbond.select.SelectUnbondFragment
import jp.co.soramitsu.featurestakingimpl.presentation.staking.unbond.select.SelectUnbondPayload
import jp.co.soramitsu.featurestakingimpl.presentation.validators.change.custom.settings.CustomValidatorsSettingsFragment
import jp.co.soramitsu.featurestakingimpl.presentation.validators.details.CollatorDetailsFragment
import jp.co.soramitsu.featurestakingimpl.presentation.validators.details.ValidatorDetailsFragment
...
import jp.co.soramitsu.featureaccountimpl.presentation.account.details.AccountDetailsFragment
import jp.co.soramitsu.featureaccountimpl.presentation.account.export.WalletExportFragment
import jp.co.soramitsu.featureaccountimpl.presentation.account.exportaccounts.AccountsForExportFragment
import jp.co.soramitsu.featureaccountimpl.presentation.account.list.AccountChosenNavDirection
import jp.co.soramitsu.featureaccountimpl.presentation.account.list.AccountListFragment
import jp.co.soramitsu.featureaccountimpl.presentation.exporting.json.confirm.ExportJsonConfirmFragment
import jp.co.soramitsu.featureaccountimpl.presentation.exporting.json.confirm.ExportJsonConfirmPayload
import jp.co.soramitsu.featureaccountimpl.presentation.exporting.json.password.ExportJsonPasswordFragment
import jp.co.soramitsu.featureaccountimpl.presentation.exporting.mnemonic.ExportMnemonicFragment
import jp.co.soramitsu.featureaccountimpl.presentation.exporting.seed.ExportSeedFragment
import jp.co.soramitsu.featureaccountimpl.presentation.importing.ImportAccountFragment
import jp.co.soramitsu.featureaccountimpl.presentation.mnemonic.backup.BackupMnemonicFragment
import jp.co.soramitsu.featureaccountimpl.presentation.mnemonic.confirm.ConfirmMnemonicFragment
import jp.co.soramitsu.featureaccountimpl.presentation.mnemonic.confirm.ConfirmMnemonicPayload
import jp.co.soramitsu.featureaccountimpl.presentation.node.add.AddNodeFragment
import jp.co.soramitsu.featureaccountimpl.presentation.node.details.NodeDetailsFragment
import jp.co.soramitsu.featureaccountimpl.presentation.node.details.NodeDetailsPayload
import jp.co.soramitsu.featureaccountimpl.presentation.node.list.NodesFragment
import jp.co.soramitsu.featureaccountimpl.presentation.pincode.PinCodeAction
import jp.co.soramitsu.featureaccountimpl.presentation.pincode.PincodeFragment
import jp.co.soramitsu.featureaccountimpl.presentation.pincode.ToolbarConfiguration
import jp.co.soramitsu.featurecrowdloanimpl.presentation.CrowdloanRouter
import jp.co.soramitsu.featurecrowdloanimpl.presentation.contribute.confirm.ConfirmContributeFragment
...
import jp.co.soramitsu.featurecrowdloanimpl.presentation.contribute.custom.CustomContributeFragment
import jp.co.soramitsu.featurecrowdloanimpl.presentation.contribute.custom.model.CustomContributePayload
import jp.co.soramitsu.featurecrowdloanimpl.presentation.contribute.select.CrowdloanContributeFragment
...
import jp.co.soramitsu.featurewalletimpl.presentation.balance.detail.BalanceDetailFragment
import jp.co.soramitsu.featurewalletimpl.presentation.model.OperationParcelizeModel
import jp.co.soramitsu.featurewalletimpl.presentation.receive.ReceiveFragment
import jp.co.soramitsu.featurewalletimpl.presentation.send.TransferDraft
import jp.co.soramitsu.featurewalletimpl.presentation.send.amount.ChooseAmountFragment
import jp.co.soramitsu.featurewalletimpl.presentation.send.confirm.ConfirmTransferFragment
import jp.co.soramitsu.featurewalletimpl.presentation.send.recipient.ChooseRecipientFragment
import jp.co.soramitsu.featurewalletimpl.presentation.transaction.detail.extrinsic.ExtrinsicDetailFragment
import jp.co.soramitsu.featurewalletimpl.presentation.transaction.detail.extrinsic.ExtrinsicDetailsPayload
import jp.co.soramitsu.featurewalletimpl.presentation.transaction.detail.reward.RewardDetailFragment
import jp.co.soramitsu.featurewalletimpl.presentation.transaction.detail.reward.RewardDetailsPayload
import jp.co.soramitsu.featurewalletimpl.presentation.transaction.detail.transfer.TransferDetailFragment
